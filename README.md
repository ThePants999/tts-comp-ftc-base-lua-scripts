...
* Dice roller enhancements: support for moving the dice mat and/or roller separately, more readable last roll reports, removed the stupid PRNG seed handling
