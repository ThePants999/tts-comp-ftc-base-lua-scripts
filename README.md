...
* Dice roller enhancements: support for moving the dice mat and/or roller separately, more readable last roll reports, added custom dice support, removed the stupid PRNG seed handling
